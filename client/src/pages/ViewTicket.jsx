...
function ViewTicket() {
    ...
    const fetchActivities = async (ticketId) => {
        ...
        try {
            ...
            console.error(
                "Unable to fetch ticket activities:",
                error
            );
    ...
    const openTicket = async (ticket) => {
        try {
            ...
            await fetchActivities(ticket.id);
        ...
        return (
            <div className="ticket-detail-page">
                    ...
                    <div className="ticket-hero-content">
                        ...
                        <div className="ticket-heading-row">
                            ...
                            <div>
                                ...
                                <div className="ticket-number-label">
                                ...
                                <div className="ticket-created-line">
                                    Created by{" "}
                                    <strong>
                                        {creatorName}
                                    </strong>
                ...
                <div className="ticket-workspace">
                    ...
                    <main className="ticket-content-column">
                            ...
                            >
                                ...
                                <textarea
                                    ...
                                    placeholder={
                                        commentType ===
                                        "internal_note"
                                            ? "Add an internal note for support staff..."
                                            : "Write a reply..."
                                    }
                                    rows="4"
                                    style={{
